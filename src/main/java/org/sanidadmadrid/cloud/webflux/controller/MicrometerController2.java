...
public class MicrometerController2 {
	
	@Autowired
	private RestTemplate restTemplate;


	@GetMapping(value = "/micrometerend", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping("/micrometercalled")
	private String micrometerCalled() {
		log.info(String.format("atendemos la llamada{}", ""));
		try {
			...
			// TODO Auto-generated catch block
			log.error("ERROR TRATANDO ATENDIENDO LA LLAMADA:{}", "", e);
			return "ATENCION ERROR";
		}
